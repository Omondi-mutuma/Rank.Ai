...
const Hero: React.FC = () => {
  ...
  return (
    <section className=" flex flex-col justify-center items-center gap-[10px] my-10 transition-all">
      {/* Badge section */}
      <div className="lg:mt-10 flex box-border text-[14px] md:text-[16px] font-regular text-custom-purple gap-2 justify-center items-center px-[14px] py-[8px] border border-white/5 rounded-[40px] bg-background">
